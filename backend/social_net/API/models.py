...
#     def create(self, author: AuthorModel, **kwargs: Any) -> _T:
#         if ('origin' in kwargs) and (not kwargs['origin']):
#             post_id = uuid.uuid4
#             origin = author.host + 'service/authors/' + author.pk + '/posts/'
#             kwargs.update({"origin":})
...
class PostModel(models.Model):
    ...
    categories = models.ManyToManyField(CategoriesModel, blank=True)
