...
/* harmony import */ var _components_Sidebar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6073);
/* harmony import */ var _components_Post__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8326);
...
/* harmony import */ var _supabase_auth_helpers_nextjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(4001);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_components_Post__WEBPACK_IMPORTED_MODULE_3__, _nodes__WEBPACK_IMPORTED_MODULE_8__]);
([_components_Post__WEBPACK_IMPORTED_MODULE_3__, _nodes__WEBPACK_IMPORTED_MODULE_8__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const getServerSideProps = async (context)=>{
    const supabaseServerClient = (0,_supabase_auth_helpers_nextjs__WEBPACK_IMPORTED_MODULE_7__.createServerSupabaseClient)(context);
    ...
    try {
        let [authorId, postId] = [
            ...
            context.params?.post_id
        ];
        let post = await _nodes__WEBPACK_IMPORTED_MODULE_8__/* ["default"].getPost */ .Z.getPost(authorId, postId);
        let comments = await _nodes__WEBPACK_IMPORTED_MODULE_8__/* ["default"].getComments */ .Z.getComments(authorId, postId);
        let visibility = post?.visibility;
        if (visibility === "PRIVATE") {
            if (authorId != user.id) {
                let followStatus = await _nodes__WEBPACK_IMPORTED_MODULE_8__/* ["default"].checkFollowerStatus */ .Z.checkFollowerStatus(authorId, user.id);
...
var __webpack_exports__ = __webpack_require__.X(0, [210,676,664,186,73,439,326], () => (__webpack_exec__(3055)));
