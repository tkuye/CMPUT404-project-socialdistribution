...
const MDEditor = next_dynamic__WEBPACK_IMPORTED_MODULE_2___default()(null, {
    loadableGenerated: {
        modules: [
            "authors/[author_id]/posts/[post_id]/edit.tsx -> " + "@uiw/react-md-editor"
        ]
    },
    ssr: false
});
const Edit = ({ post , postId , authorId  })=>{
    const [selectValue, setSelectValue] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(post.contentType);
    const [markDownValue, setMarkDownValue] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(post.contentType === "text/markdown" ? post.content : undefined);
    ...
    const onSubmit = async (data)=>{
        ...
        try {
            ...
            let updatedPost = await _nodes__WEBPACK_IMPORTED_MODULE_12__/* ["default"].updatePost */ .Z.updatePost(authorId, postId, post);
            if (updatedPost) {
                await _nodes__WEBPACK_IMPORTED_MODULE_12__/* ["default"].alertNewPost */ .Z.alertNewPost(authorId, post);
            }
...
const getServerSideProps = async (context)=>{
    ...
    let authorId = context.params?.author_id;
    let postId = context.params?.post_id;
    ...
    let post = await _nodes__WEBPACK_IMPORTED_MODULE_12__/* ["default"].getPost */ .Z.getPost(authorId, postId);
    if (!post) {
        return {
            notFound: true
        };
...
var __webpack_exports__ = __webpack_require__.X(0, [210,676,664,152,186,73,312,439,942], () => (__webpack_exec__(3673)));
